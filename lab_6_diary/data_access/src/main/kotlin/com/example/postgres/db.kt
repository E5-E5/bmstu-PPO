...
class PostgresDBConnector() {
    ...
    private fun connect() {
        try {
            ...
            connection = DriverManager.getConnection(ConfigReader.dbUrl.toString(),
                ConfigReader.dbUser.toString(), ConfigReader.dbPassword.toString())
        } catch (e: Exception) {
...
//    connector.disconnect()
    ...
    try {
        ...
        println("Error connect: ${e.message}, $e")
    }
}